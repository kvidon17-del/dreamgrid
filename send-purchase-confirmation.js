...
export default async function handler(req, res) {
  ...
  const { userEmail, dreamTitle, tierLabel, price, immediateStartRequestedAt, dreamUrl, cancelUrl } = req.body || {};
...
<table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#0f1228;border:1px solid rgba(167,139,250,0.25);border-radius:16px;overflow:hidden;">
  ...
  <tr><td style="padding:24px 32px 8px;">
    <p style="font-size:13px;color:rgba(255,255,255,0.65);line-height:1.7;margin:0 0 12px;">
      To withdraw and request a refund within 14 days, use the button below or contact us at
    ...
    ${cancelUrl ? `
    <a href="${escapeHtml(cancelUrl)}" style="display:inline-block;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.15);color:#ffffff;text-decoration:none;padding:10px 20px;border-radius:10px;font-size:13px;font-weight:600;">
      Cancel this spot &amp; get a refund
    </a>` : ''}
  </td></tr>
